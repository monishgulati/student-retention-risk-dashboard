...
export const TopAtRiskStudents = memo(() => {
  ...
  const animProps: any = students.length > 2000 ? {} : {
    ...
    >
      ...
      <div className="space-y-3">
        {topRisk.map((student, i) => {
          ...
          const animPropsItem: any = students.length > 2000 ? {} : {
...
TopAtRiskStudents.displayName = "TopAtRiskStudents";
